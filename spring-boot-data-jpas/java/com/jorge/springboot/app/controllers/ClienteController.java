package com.jorge.springboot.app.controllers;
...
import com.jorge.springboot.app.models.service.IClienteService;
import com.jorge.springboot.app.models.service.IUploadFileService;
import com.jorge.springboot.app.util.paginator.PageRender;
...
public class ClienteController {
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model) {
		...
		model.addAttribute("titulo", "listadode  clientes");
	...
	public String guardar(@Valid Cliente cliente, BindingResult result, Model model,
		...
		if (!foto.isEmpty()) {
			...
			flash.addFlashAttribute("info", "Archibo  subido  Correctamente '" + uniqueFileName + "'");
